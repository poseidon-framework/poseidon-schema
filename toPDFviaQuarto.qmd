...
subtitle: PDF version of the standard at <https://github.com/poseidon-framework/poseidon-schema> generated on `r Sys.Date() |> format(format = "%Y-%m-%d")` based on the current Git commit `r system("git rev-parse --short HEAD", intern=TRUE)`
format:
  pdf:
#### general settings ####
    #keep-tex: true
